defmodule MineSweeperWorldWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MineSweeperWorldWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use MineSweeperWorldWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import MineSweeperWorldWeb.ConnCase
    end
  end
